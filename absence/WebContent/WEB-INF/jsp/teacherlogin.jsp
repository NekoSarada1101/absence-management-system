...
<header class="w-100 p-1 mb-5 z-depth-1 purple-gradient text-white">
...
<div class="container p-0">
    <article class="border rounded col-lg-6 col-md-8 col-sm-10 col-10 mr-auto ml-auto bg-white">
        <h4 class="text-center mt-4 mb-4">教員ログイン</h4>

        <form action="teacherauth" method="post">
            <%--教員番号入力フォーム--%>
            <div class="md-form col-8 mr-auto ml-auto p-0">
                <input type="text" id="form1" class="form-control" maxlength="4" name="id" autofocus required>
